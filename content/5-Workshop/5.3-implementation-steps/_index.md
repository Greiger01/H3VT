...
![Create frontend S3 bucket](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/S3/CreateS3.png?width=90pc&classes=shadow)
...
![Upload frontend files](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/S3/upload.png?width=90pc&classes=shadow)
...
![Create origin access](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cloudfront/create-origin-access.png?width=90pc&classes=shadow)
...
![Create CloudFront](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cloudfront/createCloudF.png?width=90pc&classes=shadow)
...
![Choose CloudFront settings](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cloudfront/choose%20setting.png?width=90pc&classes=shadow)
...
![Create WAF](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/WAF/createWAF.png?width=90pc&classes=shadow)
...
![Connect WAF to CloudFront](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/WAF/connect-CLF.png?width=90pc&classes=shadow)
...
![Create Cognito](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cognito/createCog.png?width=90pc&classes=shadow)
...
![Edit app client](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cognito/edit-appclient.png?width=90pc&classes=shadow)
...
![Return URL](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cognito/returnURL.png?width=90pc&classes=shadow)
...
![Create group](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cognito/create-group.png?width=90pc&classes=shadow)
...
![Create user](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cognito/create-user.png?width=90pc&classes=shadow)
...
![Create HelpdeskCategories table](/H3VT/images/5-Workshop/5.3-Implementation/Backend/DynamoDB/CateDB.png?width=90pc&classes=shadow)
...
![Create HelpdeskTickets table](/H3VT/images/5-Workshop/5.3-Implementation/Backend/DynamoDB/TicketDB.png?width=90pc&classes=shadow)
...
![Create HelpdeskComments table](/H3VT/images/5-Workshop/5.3-Implementation/Backend/DynamoDB/CommentDB.png?width=90pc&classes=shadow)
...
![Create attachment bucket](/H3VT/images/5-Workshop/5.3-Implementation/Backend/S3-attachment/createS3-attachment.png?width=90pc&classes=shadow)
...
![Create submit function](/H3VT/images/5-Workshop/5.3-Implementation/Backend/Lambda-SubmitFunction/createFunction.png?width=90pc&classes=shadow)
...
![Upload backend](/H3VT/images/5-Workshop/5.3-Implementation/Backend/Lambda-SubmitFunction/uploadbackend.png?width=90pc&classes=shadow)
...
![Set environment](/H3VT/images/5-Workshop/5.3-Implementation/Backend/Lambda-SubmitFunction/setting%20environment.png?width=90pc&classes=shadow)
...
![Create HTTP API](/H3VT/images/5-Workshop/5.3-Implementation/Backend/API/create-HTTP-API.png?width=90pc&classes=shadow)
...
![Add API route](/H3VT/images/5-Workshop/5.3-Implementation/Backend/API/add-route-API.png?width=90pc&classes=shadow)
...
![Add Lambda trigger](/H3VT/images/5-Workshop/5.3-Implementation/Backend/API/add-triggerAPI-forSubFunction.png?width=90pc&classes=shadow)
...
![Create DLQ](/H3VT/images/5-Workshop/5.3-Implementation/Backend/SQS/DLQ/createDLQ.png?width=90pc&classes=shadow)
...
![Create SQS queue](/H3VT/images/5-Workshop/5.3-Implementation/Backend/SQS/Queue/createSQS-queue.png?width=90pc&classes=shadow)
...
![Add DLQ to queue](/H3VT/images/5-Workshop/5.3-Implementation/Backend/SQS/Queue/add-DLQ.png?width=90pc&classes=shadow)
...
![Create notification function](/H3VT/images/5-Workshop/5.3-Implementation/Notification/NotificationFunction/createFunction.png?width=90pc&classes=shadow)
...
![Upload notification worker code](/H3VT/images/5-Workshop/5.3-Implementation/Notification/NotificationFunction/upload-file.png?width=90pc&classes=shadow)
...
![Add notification environment](/H3VT/images/5-Workshop/5.3-Implementation/Notification/NotificationFunction/add-environment.png?width=90pc&classes=shadow)
...
![Add SQS trigger](/H3VT/images/5-Workshop/5.3-Implementation/Notification/NotificationFunction/add-trigger-SQS.png?width=90pc&classes=shadow)
...
![CloudWatch Lambda](/H3VT/images/5-Workshop/5.3-Implementation/Monitoring/CloudWatch/CloudWatch-Lambda.png?width=90pc&classes=shadow)
...
![CloudWatch SQS](/H3VT/images/5-Workshop/5.3-Implementation/Monitoring/CloudWatch/CloudWatch-SQS.png?width=90pc&classes=shadow)
...
![Alarm notification](/H3VT/images/5-Workshop/5.3-Implementation/Monitoring/CloudWatch/CloudWatch-notification.png?width=90pc&classes=shadow)
...
![SNS settings](/H3VT/images/5-Workshop/5.3-Implementation/Monitoring/SNS/settingSNS.png?width=90pc&classes=shadow)
...
![CodeCommit upload](/H3VT/images/5-Workshop/5.3-Implementation/CI-CD/CodeCommit/create-upload.png?width=90pc&classes=shadow)
...
![Create CodeBuild](/H3VT/images/5-Workshop/5.3-Implementation/CI-CD/CodeBuild/createCodeBuild.png?width=90pc&classes=shadow)
...
![CodePipeline test](/H3VT/images/5-Workshop/5.3-Implementation/CI-CD/Codepipeline/createCodepipeline-test.png?width=90pc&classes=shadow)
...
![Create KMS](/H3VT/images/5-Workshop/5.3-Implementation/secure/KMS/createKMS.png?width=90pc&classes=shadow)
...
![Set KMS](/H3VT/images/5-Workshop/5.3-Implementation/secure/KMS/setKMS.png?width=90pc&classes=shadow)
...
![Create backup vault](/H3VT/images/5-Workshop/5.3-Implementation/secure/Backup/createBackup-vault.png?width=90pc&classes=shadow)
...
![Create backup plan](/H3VT/images/5-Workshop/5.3-Implementation/secure/Backup/createBackup-plan.png?width=90pc&classes=shadow)
...
![Connect vault plan](/H3VT/images/5-Workshop/5.3-Implementation/secure/Backup/connect-vault-plan.png?width=90pc&classes=shadow)
