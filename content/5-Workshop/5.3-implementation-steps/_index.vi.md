...
![Tạo S3 frontend bucket](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/S3/CreateS3.png?width=90pc&classes=shadow)
...
![Upload frontend](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/S3/upload.png?width=90pc&classes=shadow)
...
![Tạo origin access](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cloudfront/create-origin-access.png?width=90pc&classes=shadow)
...
![Tạo CloudFront](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cloudfront/createCloudF.png?width=90pc&classes=shadow)
...
![Chọn cấu hình CloudFront](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cloudfront/choose%20setting.png?width=90pc&classes=shadow)
...
![Tạo WAF](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/WAF/createWAF.png?width=90pc&classes=shadow)
...
![Gắn WAF vào CloudFront](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/WAF/connect-CLF.png?width=90pc&classes=shadow)
...
![Tạo Cognito](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cognito/createCog.png?width=90pc&classes=shadow)
...
![Cấu hình app client](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cognito/edit-appclient.png?width=90pc&classes=shadow)
...
![Tạo group](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cognito/create-group.png?width=90pc&classes=shadow)
...
![Tạo user](/H3VT/images/5-Workshop/5.3-Implementation/Frontend/Cognito/create-user.png?width=90pc&classes=shadow)
...
![Tạo HelpdeskCategories table](/H3VT/images/5-Workshop/5.3-Implementation/Backend/DynamoDB/CateDB.png?width=90pc&classes=shadow)
...
![Tạo HelpdeskTickets table](/H3VT/images/5-Workshop/5.3-Implementation/Backend/DynamoDB/TicketDB.png?width=90pc&classes=shadow)
...
![Tạo HelpdeskComments table](/H3VT/images/5-Workshop/5.3-Implementation/Backend/DynamoDB/CommentDB.png?width=90pc&classes=shadow)
...
![Tạo attachment bucket](/H3VT/images/5-Workshop/5.3-Implementation/Backend/S3-attachment/createS3-attachment.png?width=90pc&classes=shadow)
...
![Tạo submit function](/H3VT/images/5-Workshop/5.3-Implementation/Backend/Lambda-SubmitFunction/createFunction.png?width=90pc&classes=shadow)
...
![Cấu hình environment](/H3VT/images/5-Workshop/5.3-Implementation/Backend/Lambda-SubmitFunction/setting%20environment.png?width=90pc&classes=shadow)
...
![Tạo HTTP API](/H3VT/images/5-Workshop/5.3-Implementation/Backend/API/create-HTTP-API.png?width=90pc&classes=shadow)
...
![Thêm route API](/H3VT/images/5-Workshop/5.3-Implementation/Backend/API/add-route-API.png?width=90pc&classes=shadow)
...
![Thêm Lambda trigger](/H3VT/images/5-Workshop/5.3-Implementation/Backend/API/add-triggerAPI-forSubFunction.png?width=90pc&classes=shadow)
...
![Tạo DLQ](/H3VT/images/5-Workshop/5.3-Implementation/Backend/SQS/DLQ/createDLQ.png?width=90pc&classes=shadow)
...
![Tạo SQS queue](/H3VT/images/5-Workshop/5.3-Implementation/Backend/SQS/Queue/createSQS-queue.png?width=90pc&classes=shadow)
...
![Gắn DLQ](/H3VT/images/5-Workshop/5.3-Implementation/Backend/SQS/Queue/add-DLQ.png?width=90pc&classes=shadow)
...
![Tạo notification function](/H3VT/images/5-Workshop/5.3-Implementation/Notification/NotificationFunction/createFunction.png?width=90pc&classes=shadow)
...
![Thêm environment](/H3VT/images/5-Workshop/5.3-Implementation/Notification/NotificationFunction/add-environment.png?width=90pc&classes=shadow)
...
![Thêm SQS trigger](/H3VT/images/5-Workshop/5.3-Implementation/Notification/NotificationFunction/add-trigger-SQS.png?width=90pc&classes=shadow)
...
![Cấu hình SNS](/H3VT/images/5-Workshop/5.3-Implementation/Monitoring/SNS/settingSNS.png?width=90pc&classes=shadow)
...
![Tạo CodeBuild](/H3VT/images/5-Workshop/5.3-Implementation/CI-CD/CodeBuild/createCodeBuild.png?width=90pc&classes=shadow)
...
![Kiểm thử CodePipeline](/H3VT/images/5-Workshop/5.3-Implementation/CI-CD/Codepipeline/createCodepipeline-test.png?width=90pc&classes=shadow)
...
![Tạo KMS](/H3VT/images/5-Workshop/5.3-Implementation/secure/KMS/createKMS.png?width=90pc&classes=shadow)
...
![Cấu hình KMS](/H3VT/images/5-Workshop/5.3-Implementation/secure/KMS/setKMS.png?width=90pc&classes=shadow)
...
![Tạo backup vault](/H3VT/images/5-Workshop/5.3-Implementation/secure/Backup/createBackup-vault.png?width=90pc&classes=shadow)
...
![Tạo backup plan](/H3VT/images/5-Workshop/5.3-Implementation/secure/Backup/createBackup-plan.png?width=90pc&classes=shadow)
...
![Gắn resource backup](/H3VT/images/5-Workshop/5.3-Implementation/secure/Backup/connect-vault-plan.png?width=90pc&classes=shadow)
